...
public class PoiUtils {
    ...
    public static ResponseEntity<byte[]> exportEmp2Excel(List<Employee> emps) {
        ...
        try {
            ...
            //3.1文档类别
            dsi.setCategory("Employee Information");
            //3.2设置文档管理员
            dsi.setManager("Shiyanlou");
            //3.3设置组织机构
            dsi.setCompany("Shiyanlou");
            //4.获取摘要信息并配置
            SummaryInformation si = workbook.getSummaryInformation();
            //4.1设置文档主题
            si.setSubject("Employee Information Form");
            //4.2.设置文档标题
            si.setTitle("Employee Information");
            //4.3 设置文档作者
            si.setAuthor("Shiyanlou");
            //4.4设置文档备注
            si.setComments("No Remark");
            //创建Excel表单
            HSSFSheet sheet = workbook.createSheet("Employee Information Form of XXX Company");
            //创建日期显示格式
            ...
            headers.setContentDispositionFormData("attachment",
                    new String("Employee Table.xls".getBytes("UTF-8"), "iso-8859-1"));
