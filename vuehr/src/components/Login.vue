<template>
  <el-form :rules="rules" class="login-container" label-position="left"
    ...
    <h3 class="login_title">Micro HR System</h3>
    ...
    <el-checkbox class="login_remember" v-model="checked"
                 label-position="left">Remember Password</el-checkbox>
...
<script>
  export default{
    data(){
      return {
        rules: {
          account: [{required: true, message: 'Please input your username', trigger: 'blur'}],
