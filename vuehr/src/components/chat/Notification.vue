    ...
    <el-container>
      <el-header style="text-align: left;padding-left: 0px">
        ...
        <el-button type="primary" size="mini" plain v-if="isAdmin" @click="dialogVisible = true"><i
          class="fa fa-send"
          style="margin-right: 15px"></i>Send System Notification
        </el-button>
      </el-header>
      <el-main style="padding: 0px;">
        ...
        <div style="color: #ea0206;font-size: 18px;text-align: center" v-if="sysmsgs.length==0">No Notice</div>
      </el-main>
    </el-container>
    <div style="text-align: left">
      <el-dialog
        ...
        <el-row>
          ...
          <el-col :span="21">
            <el-input v-model="title" size="mini" placeholder="Please input title"></el-input>
          </el-col>
        </el-row>
        <el-row style="margin-top: 10px;">
          ...
          <el-col :span="21">
            <el-input
              ...
              placeholder="Please input notification message..."
              v-model="message"></el-input>
          </el-col>
        </el-row>
        <el-row style="margin-top: 10px;padding-right: 10px">
          <el-col :offset="18">
            <el-button type="default" size="mini" @click="cancelSend">Cancel
            </el-button>
            <el-button type="primary" size="mini" @click="sendNFMsg"><i
              class="fa fa-send"
              style="margin-right: 15px"></i>Send
            </el-button>
          </el-col>
        </el-row>
      </el-dialog>
