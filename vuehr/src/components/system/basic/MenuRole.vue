<template>
  <div>
    <div style="text-align: left" v-loading="loading">
      <el-input placeholder="Please input role English name..."
                size="mini"
                style="width: 250px"
                v-model="newRole">
      ...
      <el-input
        placeholder="Please input role Chinese name..."
        size="mini"
        style="width: 250px"
        v-model="newRoleZh">
      </el-input>
      <el-button type="primary" size="mini" style="margin-left: 5px" @click="addNewRole">Add Role</el-button>
    </div>
        ...
        <el-collapse-item v-for="(item,index) in roles" :title="item.nameZh" :name="item.id" :key="item.name">
          <el-card class="box-card">
            ...
            <div style="display: flex;justify-content: flex-end;margin-right: 10px">
              <el-button size="mini" @click="cancelUpdateRoleMenu">Cancel Modification</el-button>
              <el-button type="primary" size="mini" @click="updateRoleMenu(index)">Confirm Modification</el-button>
            </div>
          </el-card>
        </el-collapse-item>
      </el-collapse>
  ...
  export default{
    ...
    methods: {
      deleteRole(rid, rname){
        var _this = this;
        this.$confirm('Delete role[' + rname + '], continue?', 'reminder', {
